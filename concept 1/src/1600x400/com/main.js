...
function animate(){
    ...
    // connect ellipse
    .to(ellipse1, 0.4, {x:7, y:10, scale:1, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse2, 0.4, {x:-13, y:-4, scale:1, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse3, 0.4, {x:2, y:-16, scale:1,ease:Expo.easeIn},"conn-=.2")
