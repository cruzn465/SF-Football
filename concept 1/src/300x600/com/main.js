...
function animate(){
    ...
    // connect ellipse
    .to(ellipse1, 0.5, {x:8, y:9, scale:.65, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse2, 0.5, {x:-12, y:-6, scale:.75, ease:Expo.easeIn},"conn-=.2")
    .to(ellipse3, 0.5, {x:7, y:-20, scale:.5, ease:Expo.easeIn},"conn-=.2")
    ...
    .staggerFrom([c_2x,c1_2x,c2_2x], .7, {x:-60,opacity:0,ease:Power4.easeIn},.3,"bg")
    .to([c_2x,c1_2x,c2_2x], .5, {opacity:0},"+=1.8")

    // F2
    .from(c3_2x, .7, {x:-70,opacity:0,ease:Power4.easeIn})
    .to([c3_2x], .5, {opacity:0},"+=1.7")

    // EF
    .staggerFrom([c4_2x,c5_2x,c6_2x], .7, {x:-60,opacity:0,ease:Power4.easeIn},.3)
